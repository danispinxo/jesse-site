...
export default function Services () {
  return (
    <main>
      ...
      <div>
        <h3>Psychotherapy Session (Individual)</h3>
        <p>
      ...
      <div>
        <h3>Psychotherapy for low-income individuals and students</h3>
        <p>
        Affordable rates for low-income individuals as well as undergraduate, masters and practicum students who would benefit from therapeutic services but lack the means and access.
        <br/>
