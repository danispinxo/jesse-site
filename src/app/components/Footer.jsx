    ...
    <div className="footer">
      ...
      <div className="office-hours">
        <div className="schedule-line">
          <div className="schedule-dates">Monday - Thursday</div>
          <div className="schedule-times">10:00am - 6:00pm</div>
        </div>

        <div className="schedule-line">
          <div className="schedule-dates">Friday</div>
          <div className="schedule-times">10:00am - 2:00pm</div>
        </div>

        <div className="schedule-line">
          <div className="schedule-dates">Saturday & Sunday</div>
          <div className="schedule-times">No Office Hours</div>
        </div>
      </div>
