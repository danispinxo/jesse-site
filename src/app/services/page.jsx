    ...
    <main className="page-content">
      ...
      <div className="section">
        <div className="section-label">
          ...
          <div className="section-image-holder">
            <img className="section-image" src="/images/Psychotherapy.webp" />
          </div>
        </div>
      ...
      <div className="section">
        <div className="section-label">
          ...
          <div className="section-image-holder">
            <img className="section-image" src="/images/ArtTherapy.webp" />
          </div>
        </div>
      ...
      <div className="section">
        <div className="section-label">
          ...
          <div className="section-image-holder">
            <img className="section-image" src="/images/LowIncome.webp" />
          </div>
        </div>
