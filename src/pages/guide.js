  ...
  return (
    <main className='page-content'>
      ...
      <div className="guide-intro">
        ...
        <p>
          If you search “therapist Toronto” the Internet will give you millions of search results. Literally. Finding the right therapist can feel hopeless and exhausting. And if you&apos;re searching for a therapist, you&apos;re probably already under a certain amount of stress as it is. Don&apos;t despair! Streamline your search by working through the FOUR following steps:
        </p>
      </div>
      ...
      <div className="section">
        ...
        <div className="section-content">
          ...
          <ul className='single-column'>
            <li>
              Counsellors, coaches, and social workers who work in spaces other than psychotherapy are also options. There are also pastoral or spiritual guides who offer counselling services. Some of these areas are regulated (i.e., social work) and others are not (i.e., coaching). There are excellent practitioners in every field so it&apos;s really about doing your homework and deciding which kind counsellor best suits your personal needs.
            </li>
            <li>
          ...
          <p>
            So, if you&apos;re still reading this AND you think psychotherapy could be the right for you then proceed to Step TWO. Otherwise, you may want to consult with your family physician for a referral to a psychiatrist or psychologist, or even conduct your own research into some of the other above-mentioned areas.
          </p>
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="section-content">
          <p className='bolded-text'>
            You want to see a psychotherapist.
          </p>
          <p>
            If you search the Psychology Today directory for therapists in Toronto you&apos;re still going to come up with 50+ pages of entries. And some of those ads will contain technical information you might find confusing and off-putting. By refining your search by asking yourself the following is a helpful way that you can wade through all that psycho-babble to find your match:
          </p>
          <ol>
            <li>
              ...
              <ul className='single-column'>
               ...
               Look for a practitioner who has experience and interest in working with your specific issue. Most therapists do list their areas of experience or interest on their web sites and many directories let you search by issue. <br/><br/>
            </li>
            <li>
              Decide whether you have a preferred treatment approach. This is where people often start to feel bogged down: psychodynamic, relational, transpersonal, CBT, EFT, EMDR? What does it all mean? Does this even matter?
              <br/> <br/>
            ...
            <li>
              ...
              <ul className='single-column'>
                ...
                <li><span>Location</span>: Is it convenient for you to get to the office? Would teletherapy (video or phone sessions) make more sense for you?</li>
                <li><span>Availability</span>: Does the therapist have office hours that work for you (evenings, weekends)? Do they offer teletherapy?</li>
                ...
                <li><span>Other considerations</span>: Sex/gender, age, race/ethnicity, religious faith, sexual orientation. It may be important for you to feel that your therapist can relate to a particular domain of experience. If this is the case, be honest with yourself. For example, a person working through sexual assault trauma may not want to work with a male therapist if her assailant was a man. Feeling a sense of safety and trust is crucial to being able to open up in therapy. Sometimes ostensibly “personal” factors do matter when choosing a therapist.</li>
              </ul>
            </li>
          </ol>
        </div>
          ...
          <ol>
            <li>
              ...
              <ul className='single-column'>
                ...
                <li><span>Directories</span>: for example, Psychology Today or the CRPO directory for general inquiries. Or consult specialist directories if you know your desired treatment modality.</li>
                <li><span>Internet searches</span>: I know, I know, it&apos;s a terrible rabbit hole, but if you have a refined or specialized idea of what you&apos;re seeking it can yield helpful results.</li>
