      ...
      <div className='resource-cards'>
        <div className='resource-card'>
          ...
          <p className='card-content'>
            <a href='https://kidshelpphone.ca/' target='_blank' rel='noreferrer'>Kids Help Phone</a> is a Canadian and world leader known for their expertise and continuous innovation as Canada&apos;s only 24/7 counselling and information service for young people.
          </p>
          <p className='card-content'>
        ...
        <div className="resource-card">
          ...
          <p className="card-content">
            Available to all Canadians seeking support. Visit <a href="https://talksuicide.ca/" target='_blank' rel='noreferrer'>Crisis Services Canada</a> for the distress centres and crisis organizations nearest you.
          </p>
          <p className="card-content">
        ...
        <div className="resource-card">
          ...
          <p className="card-content">
            <a href="https://www.hopeforwellness.ca/" target='_blank' rel='noreferrer'>Hope For Wellness</a> is available to all Indigenous peoples across Canada who need immediate crisis intervention. Experienced and culturally sensitive help line counsellors can help if you want to talk or are distressed.
          </p>
          <p className="card-content">
            Call 1-855-242-3310 (toll-free) or connect to the online Hope for Wellness chat.
          </p>
          <p className="card-content">
            Additional resources can be found <a href="https://www.camh.ca//-/media/files/community-resource-sheets/aboriginal-resources-pdf.pdf" target='_blank' rel='noreferrer'>here</a>.
          </p>
        </div>
        ...
        <div className="resource-card">
          ...
          <p className="card-content">
            <a href="https://trccmwar.ca/" target='_blank' rel='noreferrer'>Toronto Rape Crisis Centre/Multicultural Women Against Rape</a> is a grassroots, women-run collective working towards a violence-free world by providing anti-oppressive, feminist peer support to survivors of sexual violence.
          </p>
          <p className="card-content">
        ...
        <div className="resource-card">
          ...
          <p className="card-content">
            The <a href="https://www.reddoorshelter.ca/" target='_blank' rel='noreferrer'>Red Door Family Shelter</a> provides emergency shelter and support for women and children affected by domestic abuse, families experiencing a housing crisis, and refugee claimants with nowhere else to turn.
          </p>
          <p className="card-content">
