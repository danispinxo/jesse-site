  ...
  return (
    <main className="page-content">
      ...
      <div className="session-format">
        ...
        <p>
          I am currently taking on new clients in a limited capacity. <br />I am able to meet with
          you via the following teletherapy options:
        </p>
        <ul>
        ...
        <p>
          Please contact me using the form found on the <a href="/contact">Contact</a> page for more
          information.
        </p>
      </div>
      ...
      <div className="section">
        ...
        <div className="section-content">
          <p>
            Psychotherapy for individuals specializing in anxiety and stress, self esteem,
            relationships difficulties, and personal development.
          </p>
          <p>
            Build upon what was discussed in previous weeks, or explore new topics or concerns that
            have taken precedence in your life.
          </p>
          <p>
            In these sessions you are the expert of your own life. There are no judgements or
            assumptions made during our time; the focus is on collaborating with you to create a
            space where your voice, your wants, and your unique perspectives are not only heard, but
      ...
      <div className="section">
        ...
        <div className="section-content">
          <p>
            ...
            ourselves, our relationships, and the world. Art psychotherapy isn&apos;t about the end
            goal of creating “Art,” but about the process.
          </p>
          <p>
            This process means tapping into parts of the brain that often get overlooked or
            underused, but actually provide a wealth of knowledge about how we each uniquely
            experience and perceive the world.
          </p>
          <p>Pricing: $140 / 50 mins.</p>
          <p>Format: Video and telephone sessions</p>
        </div>
      ...
      <div className="section">
        ...
        <div className="section-content">
          <p>
            Sliding scale options are available* to those individuals demonstrating special need on
            a case-by-case basis. Please inquire for further details.
          </p>
